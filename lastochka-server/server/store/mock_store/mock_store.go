...
func (m *MockUsersPersistenceInterface) CredExists(method, value string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CredExists", method, value)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUsersPersistenceInterfaceMockRecorder) CredExists(method, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CredExists", reflect.TypeOf((*MockUsersPersistenceInterface)(nil).CredExists), method, value)
}
